...
<div class="container">
    ...
    <f:form method="post" action="/backend/user/change-password" modelAttribute="user" enctype="multipart/form-data">
        <div class="row">
            ...
            <div class="row g-3">
                <div class="col">
                    <f:input type="password" class="form-control" path="password" placeholder="Mật khẩu mới" aria-label="Mật khẩu mới"/>
                    <f:errors path="password" cssClass="error"></f:errors>
                </div>
                <div class="col">
                    <f:input type="password" path="rePassword" class="form-control" placeholder="Nhập lại mật khẩu mới" aria-label="Nhập lại mật khẩu mới" />

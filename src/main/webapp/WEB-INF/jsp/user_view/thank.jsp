...
<head>
    ...
    <title>Ekka | Cám ơn bạn đã đặt hàng.</title>
                        ...
                        <div class="hero-container">
                            <div class="hero-counter">
                                <div class="hero-detail">
                                    ...
                                    <h6 class="title" style="font-size: 20px">Cám ơn bạn đã đặt hàng tại <span>ekka</span></h6>
                                    <!-- Newsletter -->
                                    <div class="subscribe_form">
                                        <div class="input-group">
                                            <a href="/ekka" class="btn btn-default button"><span class="btn-text">Trở về trang chủ</span></a>
                                            <a href="/ekka/history/${order_code}" class="btn btn-default button"><span class="btn-text">Đi đến lịch sử đặt hàng</span></a>
                                        </div>
                                    </div>
                                    <!-- End Newsletter -->
                                </div>

...
<head>
    ...
    <title>Ekka | Xác minh đổi lại mật khẩu.</title>
            ...
            <div class="col-12">
                <div class="row ec_breadcrumb_inner">
                    <div class="col-md-6 col-sm-12">
                        <h2 class="ec-breadcrumb-title">Đổi mật khẩu</h2>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <!-- ec-breadcrumb-list start -->
                        <ul class="ec-breadcrumb-list">
                            <li class="ec-breadcrumb-item"><a href="index.html">Trang chủ</a></li>
                            <li class="ec-breadcrumb-item active">Đổi mật khẩu</li>
                        </ul>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="section-title">
                    <h2 class="ec-bg-title">Đổi mật khẩu</h2>
                    <h2 class="ec-title">Đổi mật khẩu</h2>
                    ...
                    <div class="ec-register-form">
                        ...
                        <f:form method="post" action="/ekka/user-verify" modelAttribute="user" enctype="multipart/form-data">
                            <span class="ec-register-wrap ec-register-half">
                                <label>Địa chỉ Email muốn đổi mật khẩu (<span class="text-danger">*</span>)</label>
                                <f:input type="email" class="form-control" path="email" name="email" placeholder="Vui lòng nhập đúng Email muốn đổi mật khẩu..."
                                         aria-label="Email" required="required"/>
                                <f:errors path="email" cssClass="error"></f:errors>
                            </span>
                            <span class="ec-register-wrap ec-register-half">
                                <label>Mã xác minh (<span class="text-danger">*</span>)</label>
                                <f:input type="text" class="form-control" path="token" name="token" placeholder="Vui lòng nhập đúng mã xác minh..."
                                         aria-label="Token" required="required"/>
                                <f:errors path="token" cssClass="error"></f:errors>
                            </span>
                            <span class="ec-register-wrap ec-register-half">
                                <label>Mật khẩu mới (<span class="text-danger">*</span>)</label>
                                    <f:input type="password" class="form-control" path="password" name="password" placeholder="Vui lòng nhập mật khẩu mới..."
                                             aria-label="Mật khẩu"/>
                            ...
                            <span class="ec-register-wrap ec-register-half">
                                <label>Nhập lại mật khẩu mới (<span class="text-danger">*</span>)</label>
                                    <f:input type="password" path="rePassword" name="rePassword" class="form-control"
                                             placeholder="Vui lòng nhập lại mật khẩu mới..." aria-label="Nhập lại mật khẩu"/>

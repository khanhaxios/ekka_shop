...
<head>
    ...
    <title>Ekka | Bạn quên mật khẩu.</title>
                    ...
                    <div class="ec-login-form">
                        <form action="/ekka/forgot-password" method="post">
                            ...
                            <span class="ec-login-wrap">
                                    ...
                                    <input type="email" name="email" placeholder="Vui lòng nhập Email muốn lấy lại mật khẩu..." required />
                                </span>
                            <span class="ec-register-wrap ec-login-btn">
                                    <button class="btn btn-primary" style="width: auto;" type="submit">Lấy lại mật khẩu</button>
                                </span>
                        </form>
                    </div>
                </div>

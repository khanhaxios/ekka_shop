...
<head>
    ...
    <title>Ekka - Admin | Nhãn hiệu | ${brandDto.nameBrand}.</title>
        ...
        <div class="ec-content-wrapper">
            <div class="content">
                <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        <a href="/ekka/admin/brand/list" type="button" class="btn btn-primary">Sửa nhãn hiệu
                        </a>
                    </div>
                </div>

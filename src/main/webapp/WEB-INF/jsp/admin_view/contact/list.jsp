...
<head>
    ...
    <title>Ekka - Admin | Liên hệ.</title>
            ...
            <div class="content">
                <div
                    ...
                    <p class="breadcrumbs"><span><a href="/ekka/admin">Trang chủ</a></span>
                        <span><i class="mdi mdi-chevron-right"></i></span>Liên hệ
                    </p>
                </div>
                <div class="row">
                    <div class="col-12">
                                                    ...
                                                    <c:if test="${contact.state == 2}">
                                                        <div class="btn-group mb-1">
                                                            <button type="button"
                                                                    ...
                                                                    data-bs-target="#infoUser-${contact.id}">Xem
                                                            </button>
                                                        </div>
                                                    </c:if>
                                                    <c:if test="${contact.state != 2}">
                                                                    ...
                                                                    <div class="card card-default">
                                                                        <div class="card-body text-center p-24px">
                                                                            ...
                                                                            <div class="d-flex justify-content-center align-items-center">
                                                                                    <c:if test="${contact.state == 1}"><a class="btn btn-success my-3 mr-2" href="#">Chờ phản hồi</a></c:if>
                                                                                    <c:if test="${contact.state == 0}"><a class="btn btn-danger my-3 mr-2" href="#">Đã khóa</a></c:if>
                                                                                    <c:if test="${contact.state == 2}"><a class="btn btn-info my-3 mr-2" href="#">Đã phản hồi</a></c:if>
                                                                        ...
                                                                        <c:if test="${contact.state == 2}">
                                                                            <div class="card-body text-center p-24px">
                                                                                ...
                                                                                <div class="ec-t-review-bottom">
                                                                                    ...
                                                                                    <div class="ec-t-review-name" style="text-align: left;">Chúng tôi xin phản hồi cho bình luận/câu hỏi của bạn:</div>

...
<head>
    ...
    <title>Ekka - Admin | Sản phẩm.</title>
        ...
        <div class="ec-content-wrapper">
            <div class="content">
                <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        <a href="/ekka/admin/product/create" class="btn btn-primary"> Thêm sản phẩm</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                                    ...
                                    <table id="responsive-data-table" class="table"
                                        ...
                                        <c:forEach items="${listProduct}" var="product">
                                            <tr>
                                                ...
                                                <td>${product.discount == null ? "(Chưa có)" : product.discount}</td>
                                                ...
                                                <td>
                                                    <div class="btn-group mb-1">
                                                            ...
                                                            <%--                                                        </button>--%>
                                                        <a style="padding: 3px 10px;" class="btn btn-outline-success" href="/ekka/admin/product/details/${product.id}">Xem</a>
                                                        <button type="button"
                                            ...
                                            <%--                                                                                    <li class="nav-item">--%>
                                            <%--                                                                                        <a class="nav-link"--%>
                                            <%--                                                                                           id="product-rejsp-tab"--%>
                                            <%--                                                                                           data-bs-toggle="tab"--%>
                                            <%--                                                                                           data-bs-target="#productrejsp"--%>
                                            <%--                                                                                           href="#productrejsp"--%>
                                            <%--                                                                                           role="tab"--%>
                                            <%--                                                                                           aria-selected="false">--%>

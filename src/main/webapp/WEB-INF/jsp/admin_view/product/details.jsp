...
<head>
    ...
    <title>Ekka - Admin | Sản phẩm | ${productDto.productName}.</title>
                                        ...
                                        <div class="row product-overview">
                                            <div class="col-12">
                                                ...
                                                <c:if test="${productDto.discount == null}">
                                                    <p class="product-price pb-0">Giá cả: $${productDto.priceProduct}</p>
                                                </c:if>
                                                <c:if test="${productDto.discount != null}">
                                                    ...
                                                    <p class="product-price">Giá cả: <span
                                                ...
                                                <p class="product-sku pb-1">Còn: ${productDto.totalProduct}</p>
                                                ...
                                                <ul class="product-color">
                                                    <c:forEach items="${listProductColor}" var="productColor">
                                                        <c:if test="${productDto.id == productColor.product.id}">
                                                            <li class="color"><span
                                                                    style="background-color:${productColor.colorName}; border: 1px solid;"></span>
                                                            </li>
                                                        </c:if>
                                                    </c:forEach>
                                                </ul>
                                                    ...
                                                    <c:forEach items="${listBrand}" var="brand">
                                                        <c:if test="${brand.id == productDto.brandId}">
                                                            <div class="card card-default" style="width: 100px">
                                                                <div class="card-body text-center" style="padding: 5px; display: grid;">
                                ...
                                <div class="row review-rating mt-4">
                                    <div class="col-12">
                                        <ul class="nav nav-tabs" id="myRatingTab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active"
                                                   ...
                                                   aria-selected="true">
                                                    <i class="mdi mdi-library-books mr-1"></i> Chi tiết</a>
                                            </li>
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link"
                                                   ...
                                                   role="tab" aria-selected="false">
                                                    <i class="mdi mdi-information mr-1"></i> Thông tin thêm</a>
                                            </li>

                                            <li class="nav-item">
                                                <a class="nav-link"
                                                   id="product-rejsp-tab" data-bs-toggle="tab"
                                                   data-bs-target="#productrejsp" href="#productrejsp"
                                                   role="tab" aria-selected="false">
                                                    <i class="mdi mdi-star-half mr-1"></i> Đánh giá của khách hàng</a>
                                            </li>
                                        </ul>
                                        <div class="tab-content" id="myTabContent2">
                                            ...
                                            <div class="tab-pane pt-3 fade" id="productrejsp" role="tabpanel">
                                                <div class="ec-t-review-wrapper">
                                                    <c:if test="${listReview == []}">
                                                        <div class="ec-t-review-item">
                                                            <h6>Sản phẩm chưa có đánh giá nào!</h6>
                                                        </div>
                                                    </c:if>
                                                    <c:if test="${listReview != []}">

...
<head>
    ...
    <title>Ekka - Admin | Đơn hàng đã giao.</title>
            ...
            <div class="content">
                <div class="breadcrumb-wrapper breadcrumb-wrapper-2">
                    ...
                    <p class="breadcrumbs"><span><a href="/ekka/admin">Trang chủ</a></span>
                        <span><i class="mdi mdi-chevron-right"></i></span>Đơn hàng đã hoàn thành
                    </p>
                </div>
                <div class="row">
                    <div class="col-12">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group mb-1">
                                                        <a style="padding: 3px 10px;" class="btn btn-outline-success" href="/ekka/admin/order/details/${bill.order_code}">Xem</a>
                                                        <button type="button"
                                                            ...
                                                            <c:if test="${bill.state == 0}">
                                                                <f:form method="post"
                                                                    ...
                                                                    <button class="dropdown-item pl-3"
                                                                            style="color: #8a909d!important" type="submit">Đang chờ
                                                                    </button>
                                                                </f:form>
                                                                <f:form method="post"
                                                                        ...
                                                                        enctype="multipart/form-data">
                                                                    <button class="dropdown-item pl-3"
                                                                            style="color: #fec400!important" type="submit">Sẵn sàng vận chuyển
                                                                    </button>
                                                                </f:form>
                                                                <f:form method="post"
                                                                        ...
                                                                        enctype="multipart/form-data">
                                                                    <button class="dropdown-item pl-3"
                                                                            style="color: #13cae1!important" type="submit">Đang vận chuyển
                                                                    </button>
                                                                </f:form>
                                                                <f:form method="post"
                                                                        ...
                                                                        enctype="multipart/form-data">
                                                                    <button class="dropdown-item pl-3"
                                                                            style="color: #29cc97!important" type="submit">Đã giao hàng
                                                                    </button>
                                                                </f:form>
                                                            </c:if>
                                                            <c:if test="${bill.state == 1}">
                                                                <f:form method="post"
                                                                        ...
                                                                        enctype="multipart/form-data">
                                                                    <button class="dropdown-item pl-3"
                                                                            style="color: #fe5461!important" type="submit">Đã hủy
                                                                    </button>
                                                                </f:form>
                                                                <f:form method="post"
                                                                        action="/ekka/admin/order/changeState2/${bill.order_code}"

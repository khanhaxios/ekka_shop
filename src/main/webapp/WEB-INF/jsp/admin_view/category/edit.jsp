...
<head>
    ...
    <title>Ekka - Admin | Loại sản phẩm | ${categoryDto.categoryName}.</title>
        ...
        <div class="ec-content-wrapper">
            <div class="content">
                <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        <a href="/ekka/admin/category/list" type="button" class="btn btn-primary">Sửa loại sản phẩm
                        </a>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="ec-cat-form">
                                    ...
                                    <f:form method="post" action="/ekka/admin/category/update" modelAttribute="categoryDto"
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label>Loại sản phẩm theo giới tính*</label>

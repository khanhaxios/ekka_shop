...
<head>
    ...
    <title>Ekka - Admin | Loại sản phẩm.</title>
                ...
                <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <p class="breadcrumbs"><span><a href="/ekka/admin">Trang chủ</a></span>
                            <span><i class="mdi mdi-chevron-right"></i></span> Loại sản phẩm</p>
                    </div>
                </div>
                                ...
                                <div class="ec-cat-form">
                                    ...
                                    <f:form method="post" action="/ekka/admin/category/save"
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label>Loại sản phẩm theo giới tính (<span style="color: red;">*</span>)</label>
                                                    <f:select path="genderCategoryId" class="form-control"
                                                              required="required">
                                                        <option value="">--Loại sản phẩm theo giới tính--</option>
                                        ...
                                        <button type="submit" class="btn btn-primary btn-pill">Thêm Loại sản phẩm</button>
                                    </f:form>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <c:forEach items="${list}" var="category">
                                            <tr>
                                                ...
                                                <td><fmt:formatDate pattern = "dd/MM/yyyy kk:mm:ss"
                                                                                          value = "${category.updated_at}"/></td>
                                                <td>
                                                    <div class="btn-group mb-1">
                                                        <button type="button"
                                                                class="btn btn-outline-success"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#infoUser-${category.id}">Xem
                                                        </button>
                                                        <button type="button"
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item"
                                                               href="/ekka/admin/category/edit/${category.id}">Sửa</a>
                                                            <c:if test="${category.state == 1}">
                                                                <f:form method="post"
                                                                ...
                                                                <div class="col-md-12 col-lg-12">
                                                                    <div class="card card-default">
                                                                        <div class="card-body text-center p-24px">
                                                                            ...
                                                                            <p class="item-count">${category.item == null ? 0 : category.item}<span> sản phẩm</span>
                                                                            </p>
                                                                            <div class="d-flex justify-content-center align-items-center">
                                                                                    ${category.state == 1 ? '<a class="btn btn-success my-3 mr-2" href="#">Đang hoạt động</a>' : '<a class="btn btn-danger my-3 mr-2" href="#">Đã khóa</a>'}

...
<head>
    ...
    <title>Ekka - Admin | Sản phẩm theo giới tính.</title>
                            ...
                            <div class="card-body">
                                <div class="ec-cat-form">
                                    ...
                                    <f:form method="post" action="/ekka/admin/gender-category/save" modelAttribute="genderCategoryDto"
                                        ...
                                        <button type="submit" class="btn btn-primary btn-pill">Thêm danh mục giới tính</button>

...
public class CategoryAdminController {
    ...
    public String save(@ModelAttribute("categoryDto") CategoryDto categoryDto, RedirectAttributes model, Model m) {
        try {
            ...
            model.addFlashAttribute("message_success", "Thêm loại sản phẩm thành công");
        } catch (Exception e) {
            model.addFlashAttribute("message_err", "Thêm loại sản phẩm thất bại");
...
//        UserEntity email = userRepository.findFirstByEmail(userDto.getEmail());
        ...
        try {
            ...
            model.addFlashAttribute("message_success", "Khóa loại sản phẩm thành công");
        } catch (Exception e) {
            model.addFlashAttribute("message_err", "Khóa loại sản phẩm thất bại");
        }
        System.out.println("id:"+id);
...
//        UserEntity email = userRepository.findFirstByEmail(userDto.getEmail());
        ...
        try {
            ...
            model.addFlashAttribute("message_success", "Khôi phục loại sản phẩm thành công");
        } catch (Exception e) {
            model.addFlashAttribute("message_err", "Khôi phục loại sản phẩm thất bại");
        }
        System.out.println("id:"+id);
...
//        model.addAttribute("genderCategoryDto", genderCategoryDto);
    ...
    public String updateCategory(@ModelAttribute("categoryDto") CategoryDto categoryDto, RedirectAttributes model, Model m) {
        ...
        try {
            ...
            model.addFlashAttribute("message_success", "Cập nhật loại sản phẩm thành công");
        } catch (Exception e) {
            model.addFlashAttribute("message_err", "Cập nhật loại sản phẩm thất bại");
        }

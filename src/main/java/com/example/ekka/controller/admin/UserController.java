...
//            int index = random.nextInt(avatar.length);
    ...
    public String detailsDeleteUser(@ModelAttribute("userDto") UserDto userDto, RedirectAttributes model, Model m) {
        ...
        try {
            ...
            model.addFlashAttribute("message_success", "Khóa tài khoản thành công");
        } catch (Exception e) {
            model.addFlashAttribute("message_err", "Khóa tài khoản thất bại");
        }
        System.out.println("id:"+id);
    ...
    public String detailsRestoreUser(@ModelAttribute("userDto") UserDto userDto, RedirectAttributes model, Model m) {
        ...
        try {
            ...
            model.addFlashAttribute("message_success", "Khôi phục tài khoản thành công");
        } catch (Exception e) {
            model.addFlashAttribute("message_err", "Khôi phục tài khoản thất bại");
        }
        System.out.println("id:"+id);

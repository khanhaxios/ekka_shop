...
//            System.out.println("gender_id: "+ productDto.getGenderCategoryId());
            ...
            model.addFlashAttribute("message_success", "Tạo sản phẩm mới thành công");
        } catch (Exception e) {
            model.addFlashAttribute("message_err", "Tạo sản phẩm mới thất bại");
...
//
        ...
        try {
            ...
            model.addFlashAttribute("message_success", "Khóa sản phẩm thành công");
        } catch (Exception e) {
            model.addFlashAttribute("message_err", "Khóa sản phẩm thất bại");
        }
        System.out.println("id:" + id);
...
//
        ...
        try {
            ...
            model.addFlashAttribute("message_success", "Khôi phục sản phẩm thành công");
        } catch (Exception e) {
            model.addFlashAttribute("message_err", "Khôi phục sản phẩm thất bại");
        }
        System.out.println("id:" + id);
...
//            System.out.println("gender_id: "+ productDto.getGenderCategoryId());
        ...
        try {
            ...
            model.addFlashAttribute("message_err", "Lưu ảnh thất bại!");
        }
...
//        ProductEntity idProduct = productRepository.findAllById(productDto.getId());
        ...
        try {
            ...
            model.addFlashAttribute("message_success", "Cập nhật sản phẩm thành công");
        } catch (Exception e) {
            model.addFlashAttribute("message_err", "Cập nhật sản phẩm thất bại");
        }

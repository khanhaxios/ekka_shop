...
public class GenderCategoryAdminController {
    ...
    public String save(@ModelAttribute("genderCategoryDto") GenderCategoryDto genderCategoryDto, RedirectAttributes model, Model m) {
        try {
            ...
            model.addFlashAttribute("message_success", "Tạo danh mục giới tính thành công");
        } catch (Exception e) {
            model.addFlashAttribute("message_err", "Tạo danh mục giới tính thất bại");
...
//        UserEntity email = userRepository.findFirstByEmail(userDto.getEmail());
        ...
        try {
            ...
            model.addFlashAttribute("message_success", "Khóa danh mục giới tính thành công");
        } catch (Exception e) {
            model.addFlashAttribute("message_err", "Khóa danh mục giới tính thất bại");
        }
        System.out.println("id:"+id);
...
//        UserEntity email = userRepository.findFirstByEmail(userDto.getEmail());
        ...
        try {
            ...
            model.addFlashAttribute("message_success", "Khôi phục danh mục giới tính thành công");
        } catch (Exception e) {
            model.addFlashAttribute("message_err", "Khôi phục danh mục giới tính thất bại");
        }
        System.out.println("id:"+id);
    ...
    public String updateGenderCategory(@ModelAttribute("genderCategoryDto") GenderCategoryDto genderCategoryDto, RedirectAttributes model, Model m) {
        ...
        try {
            ...
            model.addFlashAttribute("message_success", "Cập nhật danh mục giới tính thành công");
        } catch (Exception e) {
            model.addFlashAttribute("message_err", "Cập nhật danh mục giới tính thất bại");
        }

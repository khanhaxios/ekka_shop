...
public class ReviewAdminController {
    ...
    public String deleteReview(@PathVariable(name = "id") long id, ReviewDto reviewDto, RedirectAttributes model, Model m) {
        try {
            ...
            model.addFlashAttribute("message_success", "Khóa đánh giá thành công");
        } catch (Exception e) {
            model.addFlashAttribute("message_err", "Khóa đánh giá thất bại");
        }
    ...
    public String restoreReview(@PathVariable(name = "id") long id, ReviewDto reviewDto, RedirectAttributes model, Model m) {
        try {
            ...
            model.addFlashAttribute("message_success", "Khôi phục đánh giá thành công");
        } catch (Exception e) {
            model.addFlashAttribute("message_err", "Khôi phục đánh giá thất bại");
        }

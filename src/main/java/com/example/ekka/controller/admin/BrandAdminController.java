...
public class BrandAdminController {
    ...
    public String save(@ModelAttribute("brandDto") BrandDto brandDto, RedirectAttributes model, Model m) {
        try {
            ...
            model.addFlashAttribute("message_success", "Thêm nhãn hiệu thành công");
        } catch (Exception e) {
            model.addFlashAttribute("message_err", "Thêm nhãn hiệu thất bại");
...
//        UserEntity email = userRepository.findFirstByEmail(userDto.getEmail());
        ...
        try {
            ...
            model.addFlashAttribute("message_success", "Khóa nhãn hiệu thành công");
        } catch (Exception e) {
            model.addFlashAttribute("message_err", "Khóa nhãn hiệu thất bại");
        }
        System.out.println("id:"+id);
...
//        UserEntity email = userRepository.findFirstByEmail(userDto.getEmail());
        ...
        try {
            ...
            model.addFlashAttribute("message_success", "Khôi phục nhãn hiệu thành công");
        } catch (Exception e) {
            model.addFlashAttribute("message_err", "Khôi phục nhãn hiệu thất bại");
        }
        System.out.println("id:"+id);
    ...
    public String updateBrand(@ModelAttribute("brandDto") BrandDto brandDto, RedirectAttributes model, Model m) {
        ...
        try {
            ...
            model.addFlashAttribute("message_success", "Cập nhật nhãn hiệu thành công");
        } catch (Exception e) {
            model.addFlashAttribute("message_err", "Cập nhật nhãn hiệu thất bại");
        }

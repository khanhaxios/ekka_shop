...
public class OrderService {
    ...
    public void changeState2(OrderDto orderDto) throws Exception{
        ...
        EmailDetails emailDetails = new EmailDetails();
        emailDetails.setRecipient(orderDto.getEmail());
        emailDetails.setSubject("[THÔNG BÁO - EKKA SHOP]ĐƠN HÀNG MÃ SỐ #" + orderDto.getOrder_code() + " ĐÃ VÀO TRẠNG THÁI SẴN SÀNG VẬN CHUYỂN");
        emailDetails.setMsgBody(String.format("Thư thông báo trạng thái đơn hàng:\n" +
                "Vào đường link http://localhost:8080/ekka/history"+orderDto.getOrder_code()+" để xem lịch sử đơn hàng đã đặt!"));
        emailService.sendSimpleMail(emailDetails);
    }
    ...
    public void changeState3(OrderDto orderDto) throws Exception{
        ...
        try {
            ...
            emailDetails.setMsgBody("<!DOCTYPE HTML\n" +
                    ...
                    "                                <p style=\"font-size: 14px; line-height: 150%;\"><strong>Chi tiết\n" +
                    "                                    Vận chuyển</strong><br /><strong>Mã đơn hàng:</strong> "+orderDto.getOrder_code()+"</p>\n" +
                    "                                <p style=\"font-size: 14px; line-height: 150%;\"><br /><strong>Tên người nhận:</strong>\n" +
                    "                                  "+name_consignee+"</p>\n" +
                    "                                <p style=\"font-size: 14px; line-height: 150%;\"><strong>Địa chỉ Email:</strong> "+orderDto.getEmail()+"\n" +
                    "                                </p>\n" +
                    "                                <p style=\"font-size: 14px; line-height: 150%;\"><strong>Số điện thoại</strong> "+delivery_phone+"</p>\n" +
                    "                                <p style=\"font-size: 14px; line-height: 150%;\"><strong>Địa chỉ nhận hàng:</strong> "+delivery_address+"</p>\n" +
                    "                                <p style=\"font-size: 14px; line-height: 150%;\"><br /><strong>Ngày đặt hàng:</strong> "+createOrder+"</p><br>\n" +
                    "                                <p style=\"font-size: 14px; line-height: 150%;\"><strong>Ước tính ngày nhận hàng:</strong>\n" +
                    "                                  "+outTime+"</p>\n" +
                    "                                <p style=\"font-size: 14px; line-height: 150%;\"><strong>(*) Ghi chú nhỏ:</strong> Hãy chắc chắn kiểm tra điện thoại của bạn cho bưu kiện và kiểm tra lại thông tin gói trước khi nhận hàng.</p>\n"+
                    "                                <p style=\"font-size: 14px; line-height: 150%;\"><strong>(*) Vui lòng chuẩn bị $"+totalPrice+" để thanh toán, <a href=\"http://localhost:8080/ekka/history/"+orderDto.getOrder_code()+"\">xem chi tiết tại đây<a>.</strong></p>\n" +
                    "                              </div>\n" +
                    "\n" +
                    "                            </td>\n" +
                    "                          </tr>\n" +
                    ...
                    "                                    style=\"font-size: 20px; line-height: 30px;\"><strong>Cảm ơn bạn đẫ đồng hành cùng\n" +
                    "                                      chúng tôi!</strong></span></p>\n" +
                    "                              </div>\n" +
                    "\n" +
                    "                            </td>\n" +
                    "                          </tr>\n" +
                    ...
                    "                                      style=\"font-size: 16px; line-height: 24px;\">Lời chúc tốt nhất,</span></strong></p>\n" +
                    ...
                    "                                      style=\"font-size: 14px; line-height: 16.8px;\">Mua sắm ngay!</span></span>\n" +
                    "                                </a>\n" +
                    ...
                    "                                      style=\"font-size: 14px; line-height: 16.8px;\">Xem chi tiết hóa đơn!</span></span>\n" +
                    "                                </a>\n" +
                    "                                <!--[if mso]></center></v:roundrect><![endif]-->\n" +
                    "                              </div>\n" +
                    "\n" +
    ...
    public void save(OrderDto orderDto) throws Exception {
        ...
        try {
                            ...
                            for (int g = 0; g < orderDto.getTotalPrice().size(); g++) {
                                if (c==i && i == j && j == k && k == h && h == g) {
                                    ...
                                    if(productEntity.getState() == 0){
                                        ...
                                        throw new Exception("Sản phẩm không tồn tại, tự động bị xóa khỏi giỏ hàng!");
                                    }
                                    if(item >= orderEntity.getItem()){
                                        ...
                                        cartRepository.deleteById(Long.parseLong(orderDto.getCart().get(c)));
                                        throw new Exception("Phát hiện sản phẩm hết hàng và tự động loại bỏ khỏi giỏ hàng!");
                                    }
            ...
            String outTime = new SimpleDateFormat("dd/MM/yyyy").format(timestamp);
            ...
            emailDetails.setMsgBody("<!DOCTYPE HTML\n" +
                    ...
                    "                              <h1 class=\"v-text-align\"\n" +
                    "                                style=\"margin: 0px; color: #272e79; line-height: 140%; text-align: left; word-wrap: break-word; font-weight: normal; font-family: 'Raleway',sans-serif; font-size: 22px;\">\n" +
                    "                                Gửi ["+orderDto.getName_consignee()+"],\n" +
                    "                              </h1>\n" +
                    "\n" +
                    "                            </td>\n" +
                    "                          </tr>\n" +
                    ...
                    "                                <p style=\"font-size: 14px; line-height: 150%;\"><strong>Địa chỉ Email:</strong> "+email+"\n" +
                    "                                </p>\n" +
                    "                                <p style=\"font-size: 14px; line-height: 150%;\"><strong>Số điện thoại</strong> "+orderDto.getDelivery_phone()+"</p>\n" +
                    "                                <p style=\"font-size: 14px; line-height: 150%;\"><strong>Địa chỉ nhận hàng:</strong> "+orderDto.getDelivery_address()+"</p>\n" +
                    "                                <p style=\"font-size: 14px; line-height: 150%;\"><br /><strong>Ngày đặt hàng:</strong>\n" +
                    "                                  "+create+"</p>\n" +
                    "                                <p style=\"font-size: 14px; line-height: 150%;\"><strong>Ước tính ngày nhận hàng:</strong>\n" +
                    "                                  "+outTime+"</p>\n" +
                    "                                <p style=\"font-size: 14px; line-height: 150%;\"><strong>(*) Ghi chú nhỏ:</strong> Hãy chắc chắn kiểm tra điện thoại của bạn cho bưu kiện và kiểm tra lại thông tin gói trước khi nhận hàng.</p>\n"+
